...
public class GroupBeam {
    ...
    @Generated(hash = 1784380281)
    public GroupBeam(long code_id, int m_index, double a_upper_limit, double a_lower_limit,
            double b_upper_limit, double b_lower_limit, double c_upper_limit,
            double c_lower_limit, double d_upper_limit, double d_lower_limit,
            String a_describe, String b_describe, String c_describe, String d_describe) {
