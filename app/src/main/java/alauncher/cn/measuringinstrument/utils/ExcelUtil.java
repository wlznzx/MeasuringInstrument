        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    String _data = "";
                    int index = 1;
                    for (int i = 0; i < demoBean.getMeasurementValues().size(); i++,index++) {
                        _data = _data + demoBean.getMItems().get(i)
                                ...
                                + "\n";
                        Log.d("wlDebug", "" + demoBean.toString());
                        while (index < Integer.valueOf(demoBean.getMItems().get(i))) {
                            index++;
                            list.add("- -");
                        }
                        list.add(demoBean.getMeasurementValues().get(i));
                    }
                    // list.add("" + _data);
