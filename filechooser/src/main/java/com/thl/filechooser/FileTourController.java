...
public class FileTourController {
    ...
    public File getSDcard0() {
        String _path = getStoragePath(mContext, false);
        android.util.Log.d("wlDebug", "getSDcard0 = " + _path);
    ...
    */
    ...
    public File getSDcard1() {
        String _path = getUSBPaths(mContext);
        _path = "/storage/usbotg";
        android.util.Log.d("wlDebug", "getSDcard1 = " + _path);
        return new File(_path);
    }
    ...
    public static String getUSBPaths(Context context) {//反射获取路径
        String[] paths = null;
